...
(function (domeApp, undefined) {
	...
	domeApp.controller('CreateProjectCollectionCtr', ['$scope', '$domeUser', '$domeProjectCollection', '$domePublic', '$state', function ($scope, $domeUser, $domeProjectCollection, $domePublic, $state) {
		'use strict';
