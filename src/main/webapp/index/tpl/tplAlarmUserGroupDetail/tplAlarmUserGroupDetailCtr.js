...
(function (domeApp, undefined) {
	...
	domeApp.controller('TplAlarmUserGroupDetailCtr', ['$scope', '$http', '$domeUser', '$domeAlarm', '$domePublic', '$state','$stateParams', function ($scope, $http, $domeUser, $domeAlarm, $domePublic, $state, $stateParams) {
		'use strict';
