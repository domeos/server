...
public class DeploymentDeployHandler implements DeployResourceHandler<Deployment> {
    ...
    @Override
    public Deployment create(Version version, List<LoadBalancer> loadBalancers, List<EnvDraft> extraEnvs) throws K8sDriverException {
    ...
    public void delete() throws K8sDriverException {
        ...
        if (deploymentList != null && deploymentList.getItems() != null) {
            for (Deployment k8sDeployment : deploymentList.getItems()) {
                kubeUtils.deleteDeployment(k8sDeployment.getMetadata().getName());
            }
        }
...
//        }
    ...
    String getDeploymentName() {
        return GlobalConstant.RC_NAME_PREFIX + deployment.getName() + GlobalConstant.DEPLOYMENT_NAME_SURFIX;
    }
