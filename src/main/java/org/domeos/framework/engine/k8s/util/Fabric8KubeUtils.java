...
public class Fabric8KubeUtils implements KubeUtils<KubernetesClient> {
    ...
    @Override
    public boolean deleteDeployment(String deploymentName) throws K8sDriverException {
    ...
    @Override
    public boolean deleteDaemonSet(String daemonSetName) throws K8sDriverException {
...
//    }
    ...
    public void createEndpoints(String name, List<String> addresses) throws K8sDriverException {
        List<EndpointAddress> endpointAddresses = new ArrayList<>();
