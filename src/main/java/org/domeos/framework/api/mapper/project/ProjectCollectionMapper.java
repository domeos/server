...
public interface ProjectCollectionMapper {
    ...
    @Select("SELECT * FROM " + ProjectCollectionBiz.PROJECT_COLLECTION + " WHERE id IN ${idList}")
    List<ProjectCollection> getProjectCollectionIncludeRemovedByIdList(@Param("idList") String idList);
}
