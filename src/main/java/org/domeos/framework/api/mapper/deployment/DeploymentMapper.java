...
public interface DeploymentMapper {
    ...
    @Select("SELECT * FROM " + GlobalConstant.DEPLOY_TABLE_NAME + " WHERE id in ${idList}")
    List<Deployment> listDeploymentsIncludeRemovedByIdList( @Param("idList") String idList);
