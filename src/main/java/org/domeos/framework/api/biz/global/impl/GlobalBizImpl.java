...
public class GlobalBizImpl implements GlobalBiz {
    ...
    public GitConfig getGitConfigById(int id) {
        ...
        if (globalInfo != null) {
            return new GitConfig(globalInfo.getId(), globalInfo.getType(), globalInfo.getValue(),
                    globalInfo.getCreateTime(), globalInfo.getLastUpdate(), globalInfo.getDescription());
        }
        return null;
    }
