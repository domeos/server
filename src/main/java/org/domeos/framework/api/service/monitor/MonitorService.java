...
public interface MonitorService {
    ...
    /**
     * Get monitor data without permissions validation
     * @param targetRequest
     * @param startTime
     * @param endTime
     * @param dataSpec
     * @return
     */
    MonitorResult getMonitorDataWithoutValidation(TargetRequest targetRequest, long startTime, long endTime, String dataSpec);
