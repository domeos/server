...
public class PrivateRegistry {
    ...
    public static List<ImageTagDetail> getImageTagDetailList(String registry, String imageName, String token) {
        try {
            ...
            for (TagDetail tagDetail : ClientConfigure.executeCompletionService(tagDetails)) {
                if (tagDetail != null) {
...
//          tagDetail.setSize(size);
    ...
    private static String getHttpResposeBody(String url, String token) throws ResponseException {
    ...
    private static String generateGetImageInfoUrl(String url, String imageName) {
        if (StringUtils.isBlank(url)) {
            return null;
        }
        return url + GlobalConstant.REGISTRY_VERSION + imageName + "/" + PublicImageConstant.IMAGE_INFO;
    }
    ...
    public static List<PublicImageInfo> getPublicImageInfos(String registryUrl, String token) {
        try {
            String images = getHttpResposeBody(generateGetCatalogInfoUrl(registryUrl), token);
    ...
    public static PublicImageDetail getPublicImageDetail(String registryUrl, String token, String imageName) {
        try {
            String imageInfo = getHttpResposeBody(generateGetImageInfoUrl(registryUrl, imageName), token);
    ...
    public static String getPublicRegistryItem(String registryUrl, String token, String suffix) throws ResponseException {
        return getHttpResposeBody(generateGetItemInfoUrl(registryUrl, suffix), token);
    }
}
