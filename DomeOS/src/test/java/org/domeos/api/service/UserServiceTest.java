...
//        roleService.createAdminRole(u1);
    ...
    public void testDeleteUser() {
        testLogin();
        HttpResponseTemp<?> res = userService.deleteUser(0, "test");
        displayInfo(res);
        Assert.assertTrue(res.getResultCode() == ResultStat.OK.responseCode);
    }
    ...
    public void testGetNotExistUser() {
        HttpResponseTemp<?> res = userService.getUserInfo("test");
        displayInfo(res);
    ...
    public void testModifyUser() {
        testLogin();
//        HttpResponseTemp<?> res = userService.getUser("test");
//        u1 = (User) res.getResult();
        User u1 = userService.getUser("test");
        if (u1 != null) {
            u1.setEmail("test@test.com");
            u1.setPhone("15012345678");
    ...
    public void testChangePasswordByUser() {
        ...
        ChangeUserPassword changeUserPassword = new ChangeUserPassword("test", "test", "newtest");
    ...
    public void testChangePasswordByAdmin() {
        testLogin();
        UserPassword userPassword = new UserPassword("test", "test");
