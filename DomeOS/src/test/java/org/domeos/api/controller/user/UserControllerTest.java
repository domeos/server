...
public class UserControllerTest extends BaseTestCase {
    ...
    public void setup() throws IOException {
        ...
        // User
        FileInputStream fileInputStream = new FileInputStream("./src/test/resources/user/user.json");
        byte[] buff = new byte[fileInputStream.available()];
        fileInputStream.read(buff);
        user = objectMapper.readValue(buff, UserInfo.class);
        userStr = new String(buff);
        fileInputStream.close();
//        System.out.println(user);

        // UserPassword
        fileInputStream = new FileInputStream("./src/test/resources/user/userpassword.json");
...
//        login("admin", "admin");
        ...
        tmp.setLoginType(UserLoginType.USER);
