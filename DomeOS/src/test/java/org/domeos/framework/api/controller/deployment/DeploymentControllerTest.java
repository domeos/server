...
public class DeploymentControllerTest extends BaseTestCase {
    ...
    public void T030ModifyDeployment() throws Exception {
        ...
        flumeContainerDraft.setRegistry("0.0.0.0:5000");
        ...
        healthCheckerDraft.setUrl("0.0.0.0");
        ...
        deployContainerDraft.setImage("0.0.0.0:5000/openxxs/iperf:1.0");
