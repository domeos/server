...
public class PrivateRegistry {
    ...
    public static double getImageSize(BaseImage baseImage) {
        ...
        try {
            ...
            String urlPrefix = CommonUtil.fullUrl(baseImage.getRegistry()) + GlobalConstant.REGISTRY_VERSION
                    + baseImage.getImageName() + GlobalConstant.REGISTRY_BLOBS;
            while (element.hasNext()) {
                ...
                if (layers.has(GlobalConstant.REGISTRY_BLOBSUM)) {
                    ...
                    long tmpSize = getBlobSize(urlPrefix + blobSum);
                    size += tmpSize;
                }
            }
        } catch (IOException e) {
    ...
    public static long getBlobSize(String url) {
