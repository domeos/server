...
public class DockerImage {
    ...
    private String tag;
    private List<EnvSetting> envSettings;
    ...
    public DockerImage(int projectId, String registry, String imageName, String tag, List<EnvSetting> envSettings, long createTime) {
        this.registry = registry;
