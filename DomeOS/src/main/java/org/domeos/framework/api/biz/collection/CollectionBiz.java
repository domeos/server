...
public interface CollectionBiz {
    ...
    CollectionAuthorityMap getAuthorityMapById(int collectionId);

    CollectionAuthorityMap getCollectionByNameAndResourceType(String name, ResourceType resourceType);

    List<CollectionInfo> getAllCollectionInfo(String tableName);

    List<CollectionInfo> getCollectionInfoByUserId(String tableName, int userId);
