...
public class AllDockerImages {
    String registry;
    CopyOnWriteArrayList<BaseImage> baseImages = new CopyOnWriteArrayList<>();
    CopyOnWriteArrayList<DockerImage> projectImages = new CopyOnWriteArrayList<>();
    CopyOnWriteArrayList<String> otherImages = new CopyOnWriteArrayList<>();
