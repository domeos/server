    ...
    domeApp.directive('domeNav', ['$compile', function ($compile) { //导航栏
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    attrs.$$element.find('li').each(function () {
                ...
                link: function (scope, element) {
                    ...
                    var getLogDetailTpl = function (index) {
                        ...
                        if (buildInfo.codeInfo && buildInfo.commitInfo) {
                            ...
                            tplArr.push('               <span class="detail-content">' + $util.getFormatDate(buildInfo.commitInfo.createdAt) + '</span>');
                            tplArr.push('           </li>');
                            tplArr.push('           <li class="detail-row">');
		...
		//左侧菜单
	.directive('leftSidebar',['$location','$window', function($location,$window) {
	    return {
		    ...
		    link: function(scope) {
		        scope.$watch('loginUser',function() {
                    ...
                    scope.sidebarMenu = [
                        {
                            id: 1,
                            parentName: '开发集成', //一级菜单
                            isShow: true,   //是否显示一级菜单
                            target: '',     //没有子菜单时使用
                            targetUrl: '',  //没有子菜单时使用
                            icon:'fa fa-th-large',   //一级菜单icon
                            child: [{
                                name: '项目',   //二级子菜单名称
                                isShow: true,   //是否显示二级子菜单
                                target: 'project',   //二级子菜单类型
                                targetUrl: 'projectCollectionManage',  //二级子菜单URL
                            },{
                                name: '镜像',
                                isShow: true,
                                target: 'image',
                                targetUrl: 'imageCollectionManage',
                            },],
                        },{
                            id: 2,
                            parentName: '运维管理',
                            ...
                            child: [{
                                ...
                                isShow: true,
                                target: 'deploy',
                                targetUrl: 'deployCollectionManage',
                            },{
                                name: '集群',
                                isShow: true,
                                target: 'cluster',
                                targetUrl: 'clusterManage',
                            },{
                                name: '应用商店',
                                isShow: true,
                                target: 'appStore',
                            ...
                            targetUrl: 'globalSetting',
                            icon: 'fa fa-cog',
                        },
                    ];
                });
		        scope.$watch(function() {
		            return $window.refreshMenu;
                },function() {
		            //console.log('watch:',$window.refreshMenu);
                    scope.$stateUrl = '';
                    scope.collapseVar = 0;
