...
(function (domeApp, undefined) {
    ...
    domeApp.controller('MonitorCtr', ['$scope', '$http', '$domeCluster', '$domeDeploy', '$domeMonitor', '$domePublic', '$modal', '$domeUser', '$q', '$sce', function ($scope, $http, $domeCluster, $domeDeploy, $domeMonitor, $domePublic, $modal, $domeUser, $q, $sce) {
        'use strict';
