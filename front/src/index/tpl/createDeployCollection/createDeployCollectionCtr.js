...
(function (domeApp, undefined) {
	...
	domeApp.controller('CreateDeployCollectionCtr', ['$scope', '$domeUser', '$domeDeployCollection', '$domePublic', '$state', function ($scope, $domeUser, $domeDeployCollection, $domePublic, $state) {
		'use strict';
