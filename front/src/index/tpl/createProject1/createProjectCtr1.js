...
(function (domeApp, undefined) {
    ...
    domeApp.controller('CreateProjectCtr1', ['$scope', '$state', '$domeData', '$modal', '$domeProject', '$domePublic', '$sce', '$domeGlobal', function ($scope, $state, $domeData, $modal, $domeProject, $domePublic, $sce, $domeGlobal) {
