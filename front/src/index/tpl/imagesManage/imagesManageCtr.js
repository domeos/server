...
(function (domeApp, undefined) {
	...
	domeApp.controller('ImagesManageCtr', ['$scope', '$state', '$stateParams', '$domeImage', '$domePublic','$domeUser', '$modal', '$cookieStore', function ($scope, $state,$stateParams, $domeImage, $domePublic,$domeUser, $modal, $cookieStore) {
