...
(function (domeApp, undefined) {
	...
	domeApp.controller('DeployManageCtr', ['$scope', '$domeDeploy', '$domeCluster', '$timeout', '$state', '$modal', '$util', function ($scope, $domeDeploy, $domeCluster, $timeout, $state, $modal, $util) {
