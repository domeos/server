...
import org.domeos.client.kubernetesclient.definitions.v1.ComponentStatus;
...
// 	items     	true    	v1.ComponentStatus array	       
...
public class ComponentStatusList {
	...
	public ComponentStatusList putKind(String kind) {
		this.kind = kind;
		return this;
	}
	...
	public ComponentStatusList putApiVersion(String apiVersion) {
		this.apiVersion = apiVersion;
		return this;
	}
	...
	public ComponentStatusList putMetadata(ListMeta metadata) {
		this.metadata = metadata;
		return this;
	}

	// for items
	public ComponentStatus[] getItems() {
		return items;
	}
	public void setItems(ComponentStatus[] items) {
		this.items = items;
	}
	public ComponentStatusList putItems(ComponentStatus[] items) {
		this.items = items;
		return this;
	}
