...
*/
import org.domeos.client.kubernetesclient.definitions.v1.ServiceAccount;
...
// 	items     	true    	v1.ServiceAccount array	       
...
public class ServiceAccountList {
	...
	// http://kubernetes.io/v1.1/docs/design/service_accounts.html#service-accounts
	...
	public ServiceAccountList putKind(String kind) {
		this.kind = kind;
		return this;
	}
	...
	public ServiceAccountList putApiVersion(String apiVersion) {
		this.apiVersion = apiVersion;
		return this;
	}
	...
	public ServiceAccountList putMetadata(ListMeta metadata) {
		this.metadata = metadata;
		return this;
	}
	...
	public ServiceAccountList putItems(ServiceAccount[] items) {
		this.items = items;
		return this;
	}
