...
// 	spec      	false   	v1beta1.JobSpec  	       
// 	status    	false   	v1beta1.JobStatus	       
...
public class Job {
	...
	public Job putKind(String kind) {
		this.kind = kind;
		return this;
	}
	...
	public Job putApiVersion(String apiVersion) {
		this.apiVersion = apiVersion;
		return this;
	}
	...
	public Job putMetadata(ObjectMeta metadata) {
		this.metadata = metadata;
		return this;
	}
	...
	public Job putSpec(JobSpec spec) {
		this.spec = spec;
		return this;
	}
	...
	public Job putStatus(JobStatus status) {
		this.status = status;
		return this;
	}
