...
// 	items     	true    	v1.ReplicationController array	       
...
public class ReplicationControllerList {
	...
	public ReplicationControllerList putKind(String kind) {
		this.kind = kind;
		return this;
	}
	...
	public ReplicationControllerList putApiVersion(String apiVersion) {
		this.apiVersion = apiVersion;
		return this;
	}
	...
	public ReplicationControllerList putMetadata(ListMeta metadata) {
		this.metadata = metadata;
		return this;
	}
	...
	public ReplicationControllerList putItems(ReplicationController[] items) {
		this.items = items;
		return this;
	}
	...
	public String formatLikeYaml(String prefix, String unitPrefix, String firstLinePrefix) {
		...
		if (items != null) {
			tmpStr += "\n" + prefix + "items:";
			for (ReplicationController ele : items) {
				tmpStr += "\n" + prefix + "- ";
				if (ele != null) {
