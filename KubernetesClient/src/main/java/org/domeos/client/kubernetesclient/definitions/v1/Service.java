...
import org.domeos.client.kubernetesclient.definitions.v1.ServiceStatus;
...
// 	spec      	false   	v1.ServiceSpec  	       
// 	status    	false   	v1.ServiceStatus	       
...
public class Service {
	...
	public Service putKind(String kind) {
		this.kind = kind;
		return this;
	}
	...
	public Service putApiVersion(String apiVersion) {
		this.apiVersion = apiVersion;
		return this;
	}
	...
	public Service putMetadata(ObjectMeta metadata) {
		this.metadata = metadata;
		return this;
	}
	...
	public Service putSpec(ServiceSpec spec) {
		this.spec = spec;
		return this;
	}
	...
	public Service putStatus(ServiceStatus status) {
		this.status = status;
		return this;
	}
