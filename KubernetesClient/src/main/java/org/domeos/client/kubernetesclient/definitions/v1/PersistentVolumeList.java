...
import org.domeos.client.kubernetesclient.definitions.v1.PersistentVolume;
...
// 	items     	true    	v1.PersistentVolume array	       
...
public class PersistentVolumeList {
	...
	public PersistentVolumeList putKind(String kind) {
		this.kind = kind;
		return this;
	}
	...
	public PersistentVolumeList putApiVersion(String apiVersion) {
		this.apiVersion = apiVersion;
		return this;
	}
	...
	public PersistentVolumeList putMetadata(ListMeta metadata) {
		this.metadata = metadata;
		return this;
	}
	...
	public PersistentVolumeList putItems(PersistentVolume[] items) {
		this.items = items;
		return this;
	}
	...
	public String formatLikeYaml(String prefix, String unitPrefix, String firstLinePrefix) {
		...
		if (items != null) {
			tmpStr += "\n" + prefix + "items:";
			for (PersistentVolume ele : items) {
				tmpStr += "\n" + prefix + "- ";
				if (ele != null) {
